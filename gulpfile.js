...
gulp.task(
  "default",
  ["readme", "world", "config", "template", "naturalEarth"],
  function () {
      ...
      files.forEach((filePath) => {
        ...
        if (countryName in NAMES) {
          ...
          if (!countryChineseName) {
            ...
            maker.makeJs(
              filePath,
              path.join("echarts-countries-js", countryFile + ".js"),
              countryChineseName,
            );
          }
        }
...
gulp.task("readme", function () {
  ...
  var options = {
    num_cities: Object.keys(countries).length,
    countries: countries,
  };
...
gulp.task("template", function () {
  ...
  glob(LOCATION + "/*.json", function (err, files) {
    ...
    var options = {
      num_countries: countryFiles.length,
...
gulp.task("naturalEarth", function () {
  NATURAL_EARTH.forEach((item) => {
    maker.makeJs(
      "geojson/shape-with-internal-borders/" + item["country"] + ".geojson",
      item["label"] + ".js",
      item["zhong_wen"],
    );
    gulp
      .src(item["label"] + ".js", { base: "." })
      .pipe(
        minify({
          noSource: true,
          ext: { min: ".js" },
...
gulp.task("custom-world", function () {
  maker.makeJs(
    "geojson/shape-with-internal-borders/eckert3-world.geojson",
    "eckert3-world.js",
    "eckert3-world",
  );
  gulp
    .src("eckert3-world.js", { base: "." })
    .pipe(
      minify({
        noSource: true,
        ext: { min: ".js" },
...
gulp.task("china-cities", function () {
  maker.makeJs(
    "./node_modules/echarts/map/json/china-cities.json",
    "china-cities.js",
    "china-cities",
  );
  gulp
    .src("china-cities.js", { base: "." })
    .pipe(
      minify({
        noSource: true,
        ext: { min: ".js" },
